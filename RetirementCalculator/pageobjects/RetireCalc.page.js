...
class RetireCalc extends Page {
    ...
    async saveButtonClick () {
        try {
            ...
            await browser.saveScreenshot('./RetirementCalculator/screenshots/RetrimentCalculator.png')
    ...
    async submitButtonClick () {
        try {
                ...
                await browser.takeScreenshot();
                await browser.saveScreenshot('./RetirementCalculator/screenshots/Submit.png')
    ...
    async verifyReport () {
        ...
        await browser.takeScreenshot()
        await browser.saveScreenshot('./RetirementCalculator/screenshots/RetirementReport.png')   
        } catch (error) {
            console.log(error);
            throw new Error(error);
        }
    ...
    async socialSecurityAsNo () {
        try {
            ...
            await browser.saveScreenshot('./RetirementCalculator/screenshots/SSN_No.png')  
        } catch (error) {
            console.log(error);
            throw new Error(error);
        }
    ...
    async socialSecurityAsYes () {
        try {
            ...
            await browser.saveScreenshot('./RetirementCalculator/screenshots/SSN_Yes.png')
        } catch (error) {
            console.log(error);
            throw new Error(error);
        }
    ...
    async verifyDefaultValues (yearsofRetirementNeedsLast) {
        try {
            ...
            await browser.saveScreenshot('./RetirementCalculator/screenshots/verifyDefaultvalues.png')
        } catch (error) {
            console.log(error);
            throw new Error(error);
        }
